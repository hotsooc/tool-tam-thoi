...
# Bot settings
VELOCITY       = 300    # Tốc độ di chuyển cao hơn
MOVE_WAIT      = 0.05   # Giảm thiểu thời gian chờ sau di chuyển
...
SCAN_INTERVAL  = 0.2    # Khoảng cách giữa các lần quét tìm mục tiêu
